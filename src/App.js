...
function App() {
  ...
  const handleFullCarousel = (position) => {
    setCurrentProduct(position);
    ...
    <div className="app">
      ...
      <div className="productContainer">
        ...
        <div className="productCarousel">
          ...
          <img src={product.images[currentProduct]} alt="img1" className="productImgMobile"/>     

          <img src={product.images[0]} alt="img1" className="productImg"/>     
          ...
          <div className="thumbnailWrapper">
            {product.images.map((img, index) => (
              <div className={index === 0 ? 'active-img' : ''} onClick={() => handleFullCarousel(index)}>
                <img key={index} src={img} alt="thumbnail1" />
              </div>
            ))}
          </div>
          ...
          {/* Full page carousel */}
          {showCarousel &&
            <div className="fullCarouselContainer">
              <div className="fcWrapper">
                {/* close btn */}
                <svg className="fcCloseBtn" onClick={() => setShowCarousel(!showCarousel)} width="14" height="15" xmlns="http://www.w3.org/2000/svg"><path d="m11.596.782 2.122 2.122L9.12 7.499l4.597 4.597-2.122 2.122L7 9.62l-4.595 4.597-2.122-2.122L4.878 7.5.282 2.904 2.404.782l4.595 4.596L11.596.782Z" fill="currentColor" fill-rule="evenodd"/></svg>

                {/* prev arrow */}
                <div className="fcArrow fca-prev" onClick={() => handleCarousel('prev')}>
                ...
                {/* product img */}
                <img src={product.images[currentProduct]} alt="product" />

                {/* next arrow */}
                <div className="fcArrow fca-next" onClick={() => handleCarousel('next')}>
                ...
                <div className="fctWrapper">
                  {product.images.map((img, index) => (
                    <div className={index === currentProduct ? 'active-img' : ''}>
                      <img key={index} src={img} alt="thumbnail1" />
                    </div>
                  ))}
                </div>
