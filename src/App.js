    ...
    <div className='app'>
      ...
      <div className='productContainer'>
        ...
        <div className='productCarousel'>
          ...
          <img
            src={product.images[currentProduct]}
            alt='img1'
          ...
          <div className='thumbnailWrapper'>
            {product.images.map((img, index) => (
              <div
                className={index === 0 ? "active-img" : ""}
                onClick={() => handleFullCarousel(index)}
              >
            ...
            <div className='fullCarouselContainer'>
              <div className='fcWrapper'>
                ...
                <div className='fctWrapper'>
                  {product.images.map((img, index) => (
                    <div
                      className={index === currentProduct ? "active-img" : ""}
                    >
                      <img key={index} src={img} alt='thumbnail1' />
                    </div>
                  ))}
        ...
        <div className='productDetails'>
          ...
          <div>
            <div className='productQty'>
              ...
              <span className='operation' onClick={() => handleQuantity("add")}>
                +
              </span>
            </div>
